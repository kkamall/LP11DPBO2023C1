...
class ProsesPasien implements KontrakPresenter
{
	...
	{
		$this->tabelpasien->open();
		$this->tabelpasien->addPasienById($nik, $nama, $tempat, $tl, $gender, $email, $telp);
		$this->tabelpasien->close();
	}
	...
	{
		$this->tabelpasien->open();
		$this->tabelpasien->editPasienById($id, $nik, $nama, $tempat, $tl, $gender, $email, $telp);
		$this->tabelpasien->close();
	}
	...
	{
		$this->tabelpasien->open();
		$this->tabelpasien->deletePasienById($id);
		$this->tabelpasien->close();
	}
